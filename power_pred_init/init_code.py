...
scaler = MinMaxScaler()
X_scaled = scaler.fit_transform(X) # Scaled before splitting ("data leakage"), so this result, as I suspected, is probably overly optimistic (specially comparing to articles I've seen).
